...
mod tests {
    ...
    use bytes::Bytes;
    use depot_test_utils::fixtures::test_signing_key;
    use http_body_util::BodyExt as _;
    use tower::util::ServiceExt as _;

    use depot_core::narinfo::NarInfoRenderer;
    ...
    async fn upstream_narinfo_fallback_returns_rendered_signed_narinfo() {
        ...
        assert!(body.contains("Sig: depot.example.com-1:"));
    }
