...
use depot_api::NarInfoPayload;
use depot_core::narinfo::{NarInfo, NarInfoRenderer};
use depot_core::nix::{NixHash, StoreDir, StorePathHash};
...
pub fn test_signing_key() -> NamedSigningKey {
    NamedSigningKey::parse("depot.example.com-1:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=")
        .unwrap()
}
